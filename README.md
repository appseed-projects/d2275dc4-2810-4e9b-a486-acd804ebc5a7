...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-07 15:04`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d2275dc4-2810-4e9b-a486-acd804ebc5a7.git
$ cd d2275dc4-2810-4e9b-a486-acd804ebc5a7
```
